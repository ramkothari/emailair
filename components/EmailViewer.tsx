          ...
          {loading ? (
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm">
                  <p>
                    ...
                    <span className="text-gray-700">{email.sender}</span>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <span className="text-gray-700">{email.date}</span>
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="whitespace-pre-wrap rounded-lg border border-gray-200 bg-white p-4 text-sm leading-6 text-gray-900">
